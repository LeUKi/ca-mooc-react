  ...
  render() {
    return (
      <>
        ...
        />
        <Menu
          style={{ 'background-color': '#18324d' }}
          theme={this.state.theme}
          onClick={this.handleClick}
          selectedKeys={[this.state.current]}
          mode="horizontal"
        >
          <Menu.Item key="1" icon={<HomeOutlined />}><Link to={'/guest/home'}>首页</Link></Menu.Item>
          ...
          <Menu.Item key="4" icon={<AudioOutlined />}><Link to={'/guest/jz'}>讲座</Link></Menu.Item>
